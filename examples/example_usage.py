...
from oneenv import oneenv, template, generate_env_example, diff, report_duplicates
...
def main():
    ...
    """
    # English: Generate the .env.example content using the registered templates.
    # Japanese: 登録されたテンプレートを使用して、.env.example の内容を生成します。
